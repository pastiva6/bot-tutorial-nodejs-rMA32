...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexBmanz = /^\/blessermanz/;botRegexNewz = /^\/news/;botRegexMax = /^\/max/;botRegexSav = /^\/smokeNsavage/;botRegexKum = /^\/kumar/; botRegexJlo = /^\/cardsmedia/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://www.youtube.com/embed/wPmogvBwIBA")
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://i.imgur.com/E1uGgGo.jpg")
    this.res.end();
  }
    ...
    this.res.writeHead(200);
    postMessage("https://i.imgur.com/CNz9n0D.png");
    this.res.end();
  }
